...
%>
	<title>The stepping to progress</title>
	<link rel="stylesheet" href="${ctx}/common/style/css/reset.css"/>
	<link rel="stylesheet" href="${ctx}/common/style/css/global.css"/>
	<link rel="stylesheet" href="${ctx}/common/style/css/component.css"/>
	<link rel="stylesheet" href="${ctx}/common/style/css/login.css"/>
	<script src="${ctx}/common/style/js/jquery-1.8.2.min.js"></script>
	<script src="${ctx}/common/style/js/jquery.cookie.js"></script>
	<script src="${ctx}/common/style/js/jquery.validate.js"></script>
	<script src="${ctx}/common/style/js/jquery.metadata.js"></script>
	<script src="${ctx}/common/style/js/jquery.validate.message_cn.js"></script>
	<script src="${ctx}/common/style/js/jquery.nicescroll.min.js"></script>
	<script src="${ctx}/common/style/js/mgTextWidth.js"></script>
	<script src="${ctx}/common/style/js/tinybox.js"></script>
    <script src="${ctx}/common/style/js/global.js"></script>
	<script src="${ctx}/common/style/js/components.js"></script>
	<script src="${ctx}/common/style/js/md5.js"></script>
	<script src="${ctx}/common/style/js/login.js"></script>
	<script>
...
<div id="login_wrapper">
	<div id="login_main">
		...
		<div class="login_form">
			...
			<form  action="${ctx}/Login.htm?flag=1" method="post"  class="login_items" onsubmit="return validate_login();"> <!-- id="login_items" -->
			<center><p6 style="color: rgb(255, 0, 0);">${tipsreg}${error}</p6></center>
				<label class="input_val"><input class="input" name="username"  autocomplete="off" /><span>用户名</span><img src="${ctx}/common/style/images/login_mail.png" /></label>
				<label class="input_val"><input class="input" name="password" type="password" value="<%=password %>" autocomplete="off" /><span>密码</span><img src="${ctx}/common/style/images/login_password.png" /></label>
				<center><p6 style="color: rgb(255, 0, 0);">${tips}</p6></center>
				<div class="login_msg">
					<p class="login_error">
						<span></span>
					</p>
			...
			<form class="register_items" action="${ctx}/doRegister.htm" method="post"> <!-- id="register_items" -->
				<label class="input_val"><input class="input" name="username" value="" autocomplete="off" /><span>用户名</span></label>
				...
				<label class="input_val"><input class="input" name="ADRESS" value="" autocomplete="off" /><span>收货地址</span></label>
				<div class="remeber">
					点击注册表示您接受
					<a id="treaty">《STEP用户协议》</a>
				</div>
				...
				<img id="vcode" alt="验证码" src="${ctx}/vcode.htm" />
    			<a href="#" onclick="changecode()">换一张</a><br>
    			<input type="text" name="vcode" placeholder="这此输入验证码" >
		...
		<p class="contactUs">联系我们：9579249@qq.com</p>
	</div>
</div>
...
<script type="text/javascript">
	var i = 1;
	function changecode(){
		document.getElementById('vcode').src="${ctx}/vcode.htm?v=" + (i++);
	}
	</script>
...
<div class="popwin_forgetPassword" style="display:none">
	...
	<div class="popwin_content">
		...
		<input class="input popwin_input popwin_newForm_input" type="text" name="EMAIL"  autocomplete="off" />
		<a class="button btn_blue popwin_forgetPassword_confirm" onclick="return find_password();">确定</a>
...
<script type="text/javascript">
						function find_password() {
							if (document.getElementsByName("EMAIL")[0].value == '') {
								...
								window.location="${ctx}/findP.htm?EMAIL="+document.getElementsByName("EMAIL")[0].value;
							}
						}
					</script>
<!-- 服务协议弹出窗 -->
<div class="popwin" id="popwin_treaty" style="display:none">
	...
	<div class="popwin_content treaty">
		<p class="treaty_content">
			&nbsp;&nbsp;&nbsp;&nbsp;若您申请STEP帐户（以下简称免费版帐户）并使用相应服务，您必须首先同意此协议。<br />
